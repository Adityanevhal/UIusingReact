...
const RightCardContent = (props) => {
  return (
    <div className='absolute top-0 left-0 p-8 flex flex-col justify-between h-full w-full'>
         ...
         <div>
            <p className='text-lg text-shadow-2xs text-white mb-14 leading-relaxed'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Officia possimus illum sint dolorum incidunt quod placeat ex! and ffvr</p>
